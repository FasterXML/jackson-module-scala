    ...
    implements java.io.Serializable
{
    ...
    public static class UpperSnakeCaseStrategy extends SnakeCaseStrategy
    {
         ...
         * @since 2.14
         */
        public final static UpperSnakeCaseStrategy INSTANCE
            = new UpperSnakeCaseStrategy();
    ...
    public static class LowerCamelCaseStrategy extends NamingBase
    {
         ...
         * @since 2.14
         */
        public final static LowerCamelCaseStrategy INSTANCE
            = new LowerCamelCaseStrategy();
