...
trait ClassTagExtensions {
  ...
  /**
   * Convenience method for constructing [[tools.jackson.databind.JavaType]] out of given
   ...
   * In either case [[tools.jackson.core.JsonParser]] must point to the first token of
  ...
  /**
   * Factory method for constructing [[tools.jackson.databind.ObjectWriter]] that will
  ...
  /**
   * Factory method for constructing {@link tools.jackson.databind.ObjectWriter} that will
  ...
  /**
   * Factory method for constructing [[tools.jackson.databind.ObjectReader]] that will
