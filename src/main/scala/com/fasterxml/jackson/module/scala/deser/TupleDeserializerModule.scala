...
private class TupleDeserializerResolver(builder: ScalaModule.ReadOnlyBuilder = ScalaModule.defaultBuilder) extends Deserializers.Base {
...
trait TupleDeserializerModule extends JacksonModule {
  this += new TupleDeserializerResolver()
}
