...
class ScalaAnnotationIntrospectorTest extends fixture.FlatSpec with Matchers {
  ...
  it should "detect a val property" ignore { mapper =>
  ...
  it should "detect annotations on a val property" ignore { mapper =>
  ...
  it should "detect a bean property" ignore { mapper =>
