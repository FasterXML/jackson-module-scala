...
class IterableSerializerTest extends SerializerTest {
  ...
  it should "serialize a Map[Int, Int]" in {
  ...
  it should "honor JsonTypeInfo" in {
    serialize(CHolder(Seq[C](X("1"), X("2")))) shouldBe """{"c":[{"@class":"tools.jackson.module.scala.ser.IterableSerializerTest$X","data":"1"},{"@class":"tools.jackson.module.scala.ser.IterableSerializerTest$X","data":"2"}]}"""
  }
