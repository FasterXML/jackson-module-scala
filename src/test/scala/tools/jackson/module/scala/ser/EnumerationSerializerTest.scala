...
class EnumerationSerializerTest extends SerializerTest {
  ...
  it should "serialize an Enumeration" in {
		val day = Weekday.Fri
		serialize(day) should be ("""{"enumClass":"tools.jackson.module.scala.Weekday","value":"Fri"}""")
	}

  it should "serialize an inner Enumeration" in {
    val day = InnerWeekday.Fri
    serialize(day) should be ("""{"enumClass":"tools.jackson.module.scala.OuterWeekday$InnerWeekday","value":"Fri"}""")
  }
  ...
  it should "serialize inline ErrorCode" in {
    val expected = """{"errorCode":"inline","severity":{"enumClass":"tools.jackson.module.scala.ser.EnumerationSerializerTest$Severity","value":"INFORMATION"}}"""
