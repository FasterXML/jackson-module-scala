...
val jacksonDatatypeVersion = "2.10.0.pr3"
...
libraryDependencies ++= Seq(
    ...
    // test dependencies
    "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % jacksonDatatypeVersion % "test",
    "com.fasterxml.jackson.datatype" % "jackson-datatype-guava" % jacksonDatatypeVersion % "test",
