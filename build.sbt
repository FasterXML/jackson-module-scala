...
libraryDependencies ++= Seq(
    ...
    "com.fasterxml.jackson.core" % "jackson-annotations" % "2.6.0-rc2",
    "com.fasterxml.jackson.core" % "jackson-databind" % "2.6.0-rc2",
    "com.thoughtworks.paranamer" % "paranamer" % "2.6",
    // test dependencies
    "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % "2.6.0-rc2" % "test",
    "com.fasterxml.jackson.datatype" % "jackson-datatype-guava" % "2.6.0-rc2" % "test",
    "com.fasterxml.jackson.module" % "jackson-module-jsonSchema" % "2.6.0-rc2" % "test",
