...
libraryDependencies ++= Seq(
    ...
    "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % "2.3.2" % "test",
    "com.fasterxml.jackson.datatype" % "jackson-datatype-guava" % "2.3.2" % "test",
    "com.fasterxml.jackson.module" % "jackson-module-jsonSchema" % "2.3.2" % "test",
