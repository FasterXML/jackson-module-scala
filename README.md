...
convert scala ClassTags directly into TypeReferences for Jackson to use (this is a direct replacement for ScalaObjectMapper which is now depecated because manifests are not supported in Scala 3):
```scala
